...
//	case 'K'eypadEquals: ret = AW_KEY_KEYPADEQUALS; break;
        ...
        case VK_SCROLL: ret = AW_KEY_SCROLL; break;
        case VK_NUMLOCK: ret = AW_KEY_NUMLOCK; break;
        case VK_CLEAR: ret = AW_KEY_CLEAR; break;
        case VK_SNAPSHOT: ret = AW_KEY_SYSREQ; break;
        case VK_PAUSE: ret = AW_KEY_PAUSE; break;
